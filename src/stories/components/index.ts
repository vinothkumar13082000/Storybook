// Component Library - All Components Exported
...
export { Space, type SpaceProps } from './Space/Space';
export { Backdrop, type BackdropProps } from './Backdrop/Backdrop';

// Existing components
export { default as Sidebar, type SidebarProps, type SidebarMenuItem } from './Sidebar/Sidebar';
